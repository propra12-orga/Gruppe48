 ...
 * -Einstellungsmoeglichkeiten der Spielfeldgroeﬂe,
...
public class OptionFrame extends JFrame implements WindowListener {
	...
	public OptionFrame() {
		...
		// Zeile 1
		JLabel lb1 = new JLabel("Spielfeldgroeﬂe:");
		 ...
		 * "‹bernehmen", "Abbrechen" der festgelegten Einstellungen
		 */

		buttons = new JPanel(new FlowLayout());

		JButton saveBt = new JButton("‹bernehmen");
	...
	/**
	 * Sicherheitsabfrage ob man ohne die ƒnderungzuspeichern das Fenster
	 * schlieﬂen moechte
	 */
